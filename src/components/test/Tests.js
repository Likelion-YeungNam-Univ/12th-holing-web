...
import {
  ...
  TestBorder,
  ImageWrapper,
} from 'styles/test/SymptomTestPage-styled';
...
function Tests() {
  ...
  const { selectedChoices, selectedDetails, handleChoiceClick } =
    setSurveyHook(); // 선택지 저장 HOOK
    ...
    return [
      {
        ...
        score: 0,
        text: test.choice1,
        selectedImg: selectedBig,
        unselectedImg: unselectedBig,
      },
      {
        id: 'choice2',
        score: 2,
        text: test.choice2,
        selectedImg: selectedSmall,
        unselectedImg: unselectedSmall,
      },
      {
        id: 'choice3',
        score: 4,
